        ...
        unsafe {
                ...
                let prob =
                    &mut *(*self
                        ...
                        .offset(
                            *self.ns2index.as_mut_ptr().offset(
                                (self.min_context.as_ref().data.single_state.freq as usize)
                    ...
                    .offset(
                        self.prev_success
                            ...
                            .wrapping_add(self.min_context.as_ref().flags as i32 as u32)
                            as isize,
                    )
                    .cast::<u16>();
            ...
            loop {
                ...
                loop {
                    ...
                    mc = self.ptr_of_offset(mc.as_ref().suffix).cast();
